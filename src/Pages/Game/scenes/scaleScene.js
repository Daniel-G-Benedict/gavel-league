...
// create the player class for insertion into the game
...
// respond to the cursors / touching
  update(cursors) {
...
// pre load assets and start the main scene
...
// when the window loads... create a new game...
